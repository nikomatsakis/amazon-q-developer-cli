...
/// Configuration for a amzn_consolas_client service client.
///
///
...
impl Builder {
    ...
    ///
    /// use amzn_consolas_client::config::Config;
    ...
    /// use std::time::Duration;
    ///
    /// use amzn_consolas_client::config::{
    ///     Builder,
    ///     Config,
    /// };
    /// use aws_smithy_runtime::client::http::hyper_014::HyperClientBuilder;
    ...
    /// }
    ///
    /// let mut builder = amzn_consolas_client::Config::builder();
    ...
    /// ```no_run
    /// use amzn_consolas_client::config::Config;
    /// use amzn_consolas_client::config::retry::RetryConfig;
    ///
    ...
    /// # use std::time::Duration;
    /// use amzn_consolas_client::config::Config;
    /// use amzn_consolas_client::config::timeout::TimeoutConfig;
    ///
    ...
    /// use std::error::Error as StdError;
    /// use std::marker::PhantomData;
    /// use amzn_consolas_client::config::{Builder, Config};
    /// # struct SomeOperationError {}
    ///
    /// const RETRYABLE_ERROR_CODES: &[&str] = [
    ///     // List error codes to be retried here...
    ...
    pub fn build(mut self) -> Config {
        ...
        layer.store_put(::aws_types::SigningName::from_static("codewhisperer"));
        layer
        ...
        Config {
            config: crate::config::Layer::from(layer.clone())
                .with_name("amzn_consolas_client::config::Config")
                .freeze(),
            cloneable: layer,
...
impl ServiceRuntimePlugin {
    pub fn new(_service_config: crate::config::Config) -> Self {
        let config = {
            let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AWSCodeWhispererService");
    ...
    pub(crate) fn new(
        ...
        Self {
            config: ::aws_smithy_types::config_bag::Layer::from(layer)
                .with_name("amzn_consolas_client::config::ConfigOverrideRuntimePlugin")
                .freeze(),
            components,
        }
    }
...
pub(crate) fn base_client_runtime_plugins(
    ...
    let default_retry_partition = "codewhisperer";
