...
/// Configuration for a amzn_qdeveloper_streaming_client service client.
///
///
...
impl Config {
    ...
    /// The signature version 4 service signing name to use in the credential scope when signing
    /// requests.
    ///
    ...
    /// This function was intended to be removed, and has been broken since release-2023-11-15 as it
    /// always returns a `None`. Do not use.
    #[deprecated(
...
impl Builder {
    ...
    ///
    /// use amzn_qdeveloper_streaming_client::config::Config;
    ...
    /// use std::time::Duration;
    ///
    /// use amzn_qdeveloper_streaming_client::config::{
    ///     Builder,
    ///     Config,
    /// };
    /// use aws_smithy_runtime::client::http::hyper_014::HyperClientBuilder;
    ...
    /// }
    ///
    /// let mut builder = amzn_qdeveloper_streaming_client::Config::builder();
    ...
    /// ```no_run
    /// use amzn_qdeveloper_streaming_client::config::Config;
    /// use amzn_qdeveloper_streaming_client::config::retry::RetryConfig;
    ///
    ...
    /// # use std::time::Duration;
    /// use amzn_qdeveloper_streaming_client::config::Config;
    /// use amzn_qdeveloper_streaming_client::config::timeout::TimeoutConfig;
    ///
    ...
    /// ```no_run
    /// use amzn_qdeveloper_streaming_client::config::IdentityCache;
    ///
    /// let config = amzn_qdeveloper_streaming_client::Config::builder()
    ...
    /// use std::error::Error as StdError;
    /// use std::marker::PhantomData;
    /// use amzn_qdeveloper_streaming_client::config::{Builder, Config};
    /// # struct SomeOperationError {}
    ///
    /// const RETRYABLE_ERROR_CODES: &[&str] = [
    ///     // List error codes to be retried here...
    ...
    pub fn build(mut self) -> Config {
        ...
        layer.store_put(::aws_types::SigningName::from_static("q"));
        layer
        ...
        Config {
            config: crate::config::Layer::from(layer.clone())
                .with_name("amzn_qdeveloper_streaming_client::config::Config")
                .freeze(),
            cloneable: layer,
    ...
    pub(crate) fn new(
        ...
        Self {
            config: ::aws_smithy_types::config_bag::Layer::from(layer)
                .with_name("amzn_qdeveloper_streaming_client::config::ConfigOverrideRuntimePlugin")
                .freeze(),
            components,
        }
    }
...
fn service_config_key<'a>(env: &'a str, profile: &'a str) -> aws_types::service_config::ServiceConfigKey<'a> {
    ::aws_types::service_config::ServiceConfigKey::builder()
        .service_id("qdeveloperstreaming")
        .env(env)
        .profile(profile)
        .build()
